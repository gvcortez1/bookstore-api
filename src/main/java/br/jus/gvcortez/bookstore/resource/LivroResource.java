...
public class LivroResource {
	...
	public ResponseEntity<Livro> create(@RequestParam(value = "categoria", defaultValue = "0") Long id_cat, 
			@Valid @RequestBody Livro objLivro) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Livro> update(@PathVariable Long id, @Valid @RequestBody Livro objLivro) {
	...
	public ResponseEntity<Livro> updatePatch(@PathVariable Long id, @Valid @RequestBody Livro objLivro) {

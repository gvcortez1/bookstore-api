...
public class DBService {
	...
	public void InstanciaBaseDeDados() {
		...
		cat1.setLivros(Arrays.asList(livro1, livro2, livro3));
		cat2.setLivros(Arrays.asList(livro2, livro3, livro4));
		cat3.setLivros(Arrays.asList(livro3, livro4, livro5));
		cat4.setLivros(Arrays.asList(livro4, livro5, livro1));
		cat5.setLivros(Arrays.asList(livro5, livro1, livro2));
